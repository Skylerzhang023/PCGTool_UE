...
#include "PCGToolEditorMode.generated.h"
 ...
 */
UCLASS()
class UPCGToolEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_PCGToolEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	UPCGToolEditorMode();
	virtual ~UPCGToolEditorMode();
