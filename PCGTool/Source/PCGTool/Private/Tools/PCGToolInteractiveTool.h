...
#include "PCGToolInteractiveTool.generated.h"
 ...
 */
UCLASS()
class PCGTOOL_API UPCGToolInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
 ...
 */
UCLASS(Transient)
class PCGTOOL_API UPCGToolInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UPCGToolInteractiveToolProperties();
 ...
 */
UCLASS()
class PCGTOOL_API UPCGToolInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UPCGToolInteractiveToolProperties> Properties;
