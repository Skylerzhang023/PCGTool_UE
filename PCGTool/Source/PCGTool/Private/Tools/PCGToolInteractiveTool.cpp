...
#include "PCGToolInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UPCGToolInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UPCGToolInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UPCGToolInteractiveTool* NewTool = NewObject<UPCGToolInteractiveTool>(SceneState.ToolManager);
...
UPCGToolInteractiveToolProperties::UPCGToolInteractiveToolProperties()
{
...
void UPCGToolInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UPCGToolInteractiveTool::Setup()
{
	...
	Properties = NewObject<UPCGToolInteractiveToolProperties>(this, "Measurement");
...
void UPCGToolInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UPCGToolInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UPCGToolInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UPCGToolInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UPCGToolInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UPCGToolInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UPCGToolInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UPCGToolInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UPCGToolInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
